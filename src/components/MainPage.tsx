        ...
        <div className="min-h-screen">
            ...
            <section className="bg-gradient-to-r from-purple-600 to-blue-600 text-white py-10 sm:py-16 md:py-20">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 text-center">
                    <h2 className="text-white mb-3 sm:mb-4 text-xl sm:text-2xl md:text-3xl lg:text-4xl">지금 가장 인기있는 뮤지컬</h2>
            ...
            <section className="max-w-7xl mx-auto px-4 sm:px-6 py-8 sm:py-12">
                <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 sm:gap-0 mb-6 sm:mb-8">
                    <h2 className="text-gray-900 text-lg sm:text-xl md:text-2xl">현재 상영중</h2>
                    <div className="flex gap-2 overflow-x-auto w-full sm:w-auto pb-2 sm:pb-0">
                        <button className="px-3 sm:px-4 py-1.5 sm:py-2 bg-purple-600 text-white rounded-lg whitespace-nowrap text-sm sm:text-base">
                            전체
                        </button>
                        <button className="px-3 sm:px-4 py-1.5 sm:py-2 bg-gray-200 text-gray-700 rounded-lg hover:bg-gray-300 whitespace-nowrap text-sm sm:text-base">
                            뮤지컬
                        </button>
                        <button className="px-3 sm:px-4 py-1.5 sm:py-2 bg-gray-200 text-gray-700 rounded-lg hover:bg-gray-300 whitespace-nowrap text-sm sm:text-base">
                            연극
                    ...
                    {showList.map(show => (
                        ...
                        >
                            <div className="relative h-64 sm:h-72 md:h-80 overflow-hidden">
                                ...
                                />
                                {show.hasCoupon && (
                                    <div className="absolute top-3 sm:top-4 right-3 sm:right-4 bg-red-500 text-white px-2 sm:px-3 py-1 rounded-full text-xs sm:text-sm">
                                        쿠폰 {show.couponDiscount}%
                                    </div>
                                )}
                            </div>
                            <div className="p-3 sm:p-4">
                                <h3 className="text-gray-900 mb-1 group-hover:text-purple-600 transition-colors text-base sm:text-lg">
                                    {show.title}
                                </h3>
                                <p className="text-xs sm:text-sm text-gray-500 mb-2 sm:mb-3 line-clamp-1">{show.subtitle}</p>
                                <div className="space-y-1.5 sm:space-y-2 text-xs sm:text-sm text-gray-600">
                                    ...
                                    <div className="flex items-center gap-1.5 sm:gap-2">
                                        ...
                                        <span className="truncate">{show.period}</span>
                                    </div>
                                </div>
                            </div>
                        </div>
